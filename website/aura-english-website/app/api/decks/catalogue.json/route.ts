...
const DECKS: DeckEntry[] = [
  ...
  {
    "id": "modern-slang",
    "name": "Modern Slang & Gen Z English",
    "description": "Stay up to date with the latest informal expressions, social media terms, and Gen Z slang.",
    "level": "B2",
    "cardCount": 45,
    "file": "decks/modern-slang.json",
  },
  {
    "id": "culinary-dining",
    "name": "Culinary & Dining Out",
    "description": "Master the vocabulary of gastronomy, from cooking techniques to ordering at fine restaurants.",
    "level": "A2",
    "cardCount": 45,
    "file": "decks/culinary-dining.json",
  },
  {
    "id": "health-wellness",
    "name": "Health & Wellness",
    "description": "Vocabulary for physical health, mental well-being, fitness, and medical situations.",
    "level": "B1",
    "cardCount": 45,
    "file": "decks/health-wellness.json",
  },
  {
    "id": "entertainment-culture",
    "name": "Entertainment & Pop Culture",
    "description": "Vocabulary for movies, music, TV shows, streaming, and modern trends.",
    "level": "B1",
    "cardCount": 45,
    "file": "decks/entertainment-culture.json",
  },
  {
    "id": "nature-environment",
    "name": "Nature & Environment",
    "description": "Vocabulary for ecology, climate change, wildlife, geography, and sustainability.",
    "level": "B2",
    "cardCount": 45,
    "file": "decks/nature-environment.json",
  },
  {
    "id": "phrasal-verbs",
    "name": "Phrasal Verbs Masterclass",
    "description": "Master the most common and useful phrasal verbs for daily English communication.",
    "level": "B2",
    "cardCount": 45,
    "file": "decks/phrasal-verbs.json",
  },
  {
    "id": "advanced-idioms",
    "name": "Advanced Idioms",
    "description": "Sound like a native speaker by mastering these figurative and idiomatic expressions.",
    "level": "C1",
    "cardCount": 45,
    "file": "decks/advanced-idioms.json",
  },
  {
    "id": "false-friends",
    "name": "False Friends (Faux-amis)",
    "description": "Avoid common mistakes for French speakers by mastering words that look similar but have different meanings.",
    "level": "B1",
    "cardCount": 45,
    "file": "decks/false-friends.json",
  },
  {
    "id": "finance-crypto",
    "name": "Finance & Crypto",
    "description": "Master the language of money, investment, banking, and the world of cryptocurrency.",
    "level": "B2",
    "cardCount": 45,
    "file": "decks/finance-crypto.json",
  },
  {
    "id": "ai-tech",
    "name": "AI & Future Tech",
    "description": "Stay ahead of the curve with vocabulary for Artificial Intelligence, machine learning, and future innovations.",
    "level": "C1",
    "cardCount": 45,
    "file": "decks/ai-tech.json",
  },
  {
    "id": "psychology-behavior",
    "name": "Psychology & Human Behavior",
    "description": "Explore the mind and human interactions with vocabulary for feelings, personality, and behavior.",
    "level": "B2",
    "cardCount": 45,
    "file": "decks/psychology-behavior.json",
  },
  // ──────────────────────────────────────────────────────
