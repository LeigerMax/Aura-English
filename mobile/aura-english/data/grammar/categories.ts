...
export const grammarCategories: GrammarCategory[] = [
  ...
  },
  {
    id: 'modals',
    title: 'Modal Verbs',
    description: 'Can, could, must, should, may, might',
    iconName: 'key-outline',
    color: '#7C3AED',
    ruleIds: ['modals_can_could', 'modals_must_have_to', 'modals_should', 'modals_may_might'],
  },
  {
    id: 'comparatives_superlatives',
    title: 'Comparatives & Superlatives',
    description: 'Bigger, the biggest, more, the most',
    iconName: 'trending-up-outline',
    color: '#D97706',
    ruleIds: ['comparatives', 'superlatives'],
  },
  {
    id: 'conditionals',
    title: 'Conditionals',
    description: 'If clauses: zero, first & second',
    iconName: 'git-branch-outline',
    color: '#059669',
    ruleIds: ['zero_conditional', 'first_conditional', 'second_conditional'],
  },
  {
    id: 'passive_voice',
    title: 'Passive Voice',
    description: 'It is spoken, it was built…',
    iconName: 'swap-horizontal-outline',
    color: '#DC2626',
    ruleIds: ['passive_present', 'passive_past'],
  },
  {
    id: 'quantifiers',
    title: 'Quantifiers',
    ...
    color: '#2563EB',
    ruleIds: ['quantifiers_some_any', 'quantifiers_much_many'],
  },
];
